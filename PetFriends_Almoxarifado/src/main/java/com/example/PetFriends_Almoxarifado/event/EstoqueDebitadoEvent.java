...
public class EstoqueDebitadoEvent implements DomainEvent {
    ...
    public EstoqueDebitadoEvent(UUID estoqueItemId, UUID pedidoId, UUID productId, int quantidade) {
    ...
    @Override
    public String eventType() { return "Estoque Debitado"; }
