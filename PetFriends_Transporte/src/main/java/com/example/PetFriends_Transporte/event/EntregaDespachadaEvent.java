...
public class EntregaDespachadaEvent implements DomainEvent {
    private final UUID entregaId;
    private final UUID pedidoId;
    private final String codigoRastreamento;
    private final Instant occurredOn = Instant.now();

    public EntregaDespachadaEvent(UUID entregaId, UUID pedidoId, String codigoRastreamento) {
    ...
    @Override
    public String eventType() { return "EntregaDespachada"; }
